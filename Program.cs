...
// entrada de escolha do usuário
			...
			Console.WriteLine("A WMS agradesce por utilizar nossos serviços.");
			Console.ReadLine();
        }

        private static void ExcluirSerie() // Solicitar a confirmação de exclusão.
		{
        ...
        private static void AtualizarSerie()
		{
			...
			Console.Write("Digite o Rating(estrela) da Série: ");
		...
		{
			Console.WriteLine();
			Console.WriteLine("WMS Séries a seu dispor !!!");
